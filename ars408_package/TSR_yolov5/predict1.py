...
from utilsYolov5.general import (LOGGER, Profile, check_img_size)
from utilsYolov5.torch_utils import select_device
...
def main():
    ...
    #model = torch.hub.load('', 'custom', path = '/weights/Rbest100ep.pt', source = 'local')
